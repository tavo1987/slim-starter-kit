...
;$(document).foundation(),$(document).ready(function(){var e=$(".section-one"),t=$(".section-two"),n=$(".sub-header"),i=$(".container-button-submit"),o=$(".header");$("#button-next").click(function(s){s.preventDefault(),e.fadeOut(),n.fadeOut(),t.fadeIn(),i.fadeIn(),$(this).parent().fadeOut(),o.css("box-shadow","none")})});
